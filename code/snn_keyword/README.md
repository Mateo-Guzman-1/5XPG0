...
1. **Research question.** e.g. "How does input encoding affect keyword
   detection accuracy and latency on a RISC-V core?" or "How small can the
   SNN be while keeping a usable detection rate?"
